        ...
        <v-panel header="Tenant Register">
            <div class="row">
                ...
                <div class=" col-md-10 col-lg-10 ">
                    ...
                    <div class='form-group row'>
                        <label class='col-md-3 text-right'>{{ labels.fullName }}:
                    ...
                    <div class="form-group row">
                        <label class='col-md-3 text-right'>{{ labels.regName }}:
                            <span class="text-danger">*</span>
                        </label>
                        <div class='col-md-9'>
                    ...
                    <div class="form-group row">
                        <label for='reg_id' class='col-md-3 text-right'>{{ labels.regNo }}:
                            <span class="text-danger">*</span>
                        </label>
                        <div class='col-md-3'>
                            <input type='text' class='form-control' name='register_tenant.reg_id' v-model='tenant.reg_id'>
                        </div>
                        <label class="col-md-3 text-right">{{ labels.regDate }}:
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-3">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 text-right">Email Address:
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-3">
                            <input name="register_tenant.email_address" type="text" class="form-control" v-model="tenant.email_address">
                        </div>
                        <label class="col-md-3 text-right">Mobile No:
                            <span class="text-danger">(tel no or mobile)*</span>
                        </label>
                        <div class="col-md-3">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 text-right">Address 1:
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-9">
                            <input name="register_tenant.address_instance.address_1" type="text" class="form-control" v-model="tenant.tenant_address.address_1">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 text-right">City:
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-3 text-right">
                            <input name="register_tenant.address_instance.city" id="register_tenant.address_instance.city" type="text" class="form-control" v-model="tenant.tenant_address.city">
                        </div>
                        <label class="col-md-3 text-right">Postal Code:
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-3">
                            <input name="register_tenant.address_instance.postal_code" id="register_tenant.address_instance.postal_code" type="text" class="form-control" v-model="tenant.tenant_address.postal_code">
                        </div>
                    </div>
                </div>
            </div>
